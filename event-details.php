...
<body>
    <div class="container">
        <h2>Détails de fête<br><?php echo htmlspecialchars($event["title"]); ?></h2>
        <?php if (!empty($event["image"])) : ?>
            <img class="event_image" src="data:image/jpeg;base64,<?php echo $event["image"]; ?>" alt="Image de fête" style="width:100%;height:auto;">
        <?php endif; ?>
